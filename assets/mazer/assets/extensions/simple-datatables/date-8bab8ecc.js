						...
						f && (c = a[2]),
							...
							(this.$d = (function (t, e, n) {
								try {
									...
									return c
										? new Date(
												Date.UTC($, m, M, D, Y, v, p + 60 * c.offset * 1e3),
											)
										: n
											? new Date(Date.UTC($, m, M, D, Y, v, p))
											: new Date($, m, M, D, Y, v, p);
								} catch (t) {
									return new Date("");
								}
							})(e, o, r)),
	...
	if (n)
		switch (n) {
			case "ISO_8601":
				...
				break;
			case "RFC_2822":
				(r = e(t.slice(5), "MM MMM YYYY HH:mm:ss ZZ").format("YYYYMMDD")),
					console.log({ date: r, content: t });
				break;
			case "MYSQL":
...
//# sourceMappingURL=date-8bab8ecc.js.map
