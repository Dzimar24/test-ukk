						...
						f && (c = a[2]),
							...
							(this.$d = (function (t, e, n) {
								try {
									...
									return c
										? new Date(
												Date.UTC(M, m, $, D, v, g, p + 60 * c.offset * 1e3),
											)
										: n
	...
	if (n)
		switch (n) {
			case "ISO_8601":
				...
				break;
			case "RFC_2822":
				(r = e(t.slice(5), "MM MMM YYYY HH:mm:ss ZZ").unix()),
					console.log({ date: r, content: t.slice(5) });
				break;
			case "MYSQL":
...
//# sourceMappingURL=date-0b1814b8.js.map
