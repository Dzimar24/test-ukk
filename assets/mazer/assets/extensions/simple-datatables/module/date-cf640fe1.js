					...
					return (
						...
						(l.add = function (t, o) {
							...
							var c = y.p(o),
								d = function (e) {
									var n = v(h);
									return y.w(n.date(n.date() + Math.round(e * t)), h);
								};
			...
			(M = function (t, e, n) {
				try {
					...
					var y = h || 0,
						...
						S = M || 0;
					return $
						? new Date(Date.UTC(Y, v, D, y, p, g, S + 60 * $.offset * 1e3))
						: n
							? new Date(Date.UTC(Y, v, D, y, p, g, S))
							: new Date(Y, v, D, y, p, g, S);
				} catch (t) {
					return new Date("");
				}
			}),
...
//# sourceMappingURL=date-cf640fe1.js.map
