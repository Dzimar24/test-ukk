						...
						function d(n) {
							...
							for (
								...
								var f = a[o],
									...
									d = h && h[0],
									l = h && h[1];
								a[o] = l ? { regex: d, parser: l } : f.replace(/^\[|\]$/g, "");
							}
							return function (t) {
							...
							r.parse = function (t) {
								...
								if ("string" == typeof u) {
									...
									f && (c = a[2]),
										...
										(this.$d = (function (t, e, n) {
											try {
												...
												return c
													...
													: n
														? new Date(Date.UTC(M, m, $, D, v, g, p))
														: new Date(M, m, $, D, v, g, p);
											} catch (t) {
												return new Date("");
											}
										})(e, u, r)),
										...
										h && e != this.format(u) && (this.$d = new Date("")),
										(s = {});
...
//# sourceMappingURL=date-82e40365.js.map
