System.register([], function (t, e) {
	...
	return {
		execute: function () {
			const s = (t) => "[object Object]" === Object.prototype.toString.call(t),
				i = (t, e) => {
				...
				a = (t) => {
					t instanceof NodeList ? t.forEach((t) => a(t)) : (t.innerHTML = "");
				},
				n = (t, e, s) =>
					i("li", { class: t, html: `<a href="#" data-page="${e}">${s}</a>` }),
				r = (t, e) => {
					let s, i;
					1 === e
						? ((s = 0), (i = t.length))
			...
			class h {
				...
				sort(t, s, i) {
					...
					if (n && 0 !== n.length) return void this.filter(t, s, i, n);
					...
					Promise.all(u).then((e) => {
						...
						Array.from(o).forEach((e) => {
							...
							s || (s = p.classList.contains("asc") ? "desc" : "asc"),
							"desc" == s
								? ((u = r(h, -1)),
									(g = r(l, -1)),
				...
				class {
									...
									this.options.plugins &&
										Object.entries(this.options.plugins).forEach(([t, e]) => {
											this[t] &&
												...
												((this[t] = this[t](e, { createElement: i })),
												e.enabled &&
													this[t].init &&
					...
					render() {
						...
						if (
							...
							this.body ||
								((this.body = i("tbody")), this.dom.appendChild(this.body)),
						...
						if (
							...
							this.options.footer
								? this.head &&
									!this.foot &&
									((this.foot = i("tfoot", { html: this.head.innerHTML })),
							...
							const s = i("select", { class: "dataTable-selector" });
						...
						if ((a(this.pagers), this.totalPages > 1)) {
							...
							this.options.firstLast &&
								...
								this.options.nextPrev &&
									!this.onFirstPage &&
									e.appendChild(n(t, s, this.options.prevText));
							let r = this.links;
							this.options.truncatePager &&
								...
								this.options.nextPrev &&
									!this.onLastPage &&
									e.appendChild(n(t, a, this.options.nextText)),
								this.options.firstLast &&
									e.appendChild(n(t, this.totalPages, this.options.lastText)),
						...
						if (
							...
							if (((this.columnWidths = []), this.dom.tHead)) {
								...
								if (
									...
									if (!this.headerTable) {
										this.headerTable = i("table", { class: "dataTable-table" });
										const e = i("div", { class: "dataTable-headercontainer" });
								...
								if ("txt" === l.type || "csv" === l.type) {
									...
									for (r = 0; r < i.length; r++)
										for (a[r] = a[r] || {}, n = 0; n < e.length; n++)
											!l.skipColumn.includes(e[n].originalCellIndex) &&
												this.columns.visible(e[n].originalCellIndex) &&
												(a[r][e[n].textContent] = i[r].cells[n].textContent);
					...
					import(t) {
						...
						if (i.data.length || s(i.data)) {
							if ("csv" === i.type) {
								...
								t.length &&
									(i.headings &&
										((e.headings = t[0].split(i.columnDelimiter)),
								...
								const t = ((t) => {
									...
									return !(null === e || (!Array.isArray(e) && !s(e))) && e;
								})(i.data);
								t &&
									((e = { headings: [], data: [] }),
									t.forEach((t, s) => {
					...
					print() {
						...
						t.forEach((t) => {
							...
							e.forEach((t) => {
								const e = i("tr");
								Array.from(t.cells).forEach((t) => {
									e.appendChild(i("td", { html: t.textContent }));
								}),
									n.appendChild(e);
							}),
							s.appendChild(a),
