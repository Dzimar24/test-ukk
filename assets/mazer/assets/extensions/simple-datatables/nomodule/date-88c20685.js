											...
											M = function (t, e) {
												return y.w(
													h
														...
														[
															t
														].apply(h.toDate("s"), (c ? [0, 0, 0, 0] : [23, 59,
																		59, 999]).slice(e)),
													h,
												);
											},
					...
					t.exports =
						...
						(M = function (t, e, n) {
							try {
								...
								return $
									? new Date(
											Date.UTC(Y, v, D, y, g, p, S + 60 * $.offset * 1e3),
										)
									: n
										? new Date(Date.UTC(Y, v, D, y, g, p, S))
										: new Date(Y, v, D, y, g, p, S);
							} catch (t) {
								return new Date("");
							}
						}),
