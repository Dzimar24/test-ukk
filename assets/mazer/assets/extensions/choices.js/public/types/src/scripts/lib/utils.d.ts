...
export declare const getAdjacentEl: (
	startEl: Element,
	selector: string,
	direction?: number,
) => Element;
export declare const isScrolledIntoView: (
	element: HTMLElement,
	parent: HTMLElement,
	direction?: number,
) => boolean;
...
export declare const sortByAlpha: (
	{ value, label }: RecordToCompare,
	{ value: value2, label: label2 }: RecordToCompare,
) => number;
export declare const sortByScore: (
	a: Pick<Choice, "score">,
	b: Pick<Choice, "score">,
) => number;
export declare const dispatchEvent: (
	element: HTMLElement,
	type: EventType,
	customArgs?: object | null,
) => boolean;
export declare const existsInArray: (
	array: any[],
	value: string,
	key?: string,
) => boolean;
