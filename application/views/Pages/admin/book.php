					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<div class="form-group">
								...
								<input type="file" name="cover" class="form-control image-preview-filepond" id="bookCover"
									required>
							</div>
						</div>
						...
						<div class="col-md-9">
							...
							<div class="form-group mt-3">
								...
								<textarea id="dark" cols="30" name="description" rows="10"></textarea>
							</div>
						</div>
					</div>
							...
							<tbody>
								...
								foreach ($viewDataBook as $key => $vdb): ?>
									<tr>
										...
										<td><?= $vdb['Judul']; ?></td>
										<td>
											<button class="btn btn-custom"><i class="bi bi-eye"></i> View Data</button>
											<a class="btn btn-warning" href="<?= site_url('admin/book/edit/' . $vdb['BukuID']) ?>"><i class="bi bi-pencil-square"></i> Edit</a>
											<a href="<?= site_url('admin/book/delete/' . $vdb['BukuID']) ?>" class="btn btn-danger"><i class="bi bi-trash"></i> Delete</a>
										</td>
									</tr>
								<?php endforeach; ?>
							</tbody>
